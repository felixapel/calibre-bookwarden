...
This directory documents the key architectural, safety, and operational decisions for **Calibre Bookwarden**:

| ADR | Title | Date | Status |
|---|---|---|---|
| [ADR-001](ADR-001-journaled-retention-recovery.md) | Resume Journaled Retention Deletion After Interruption | 2026-07-13 | Accepted |
| [ADR-002](ADR-002-exact-manifestation-v2.md) | Exact-Manifestation Metadata Verification (V2) | 2026-07-14 | Accepted |
| [ADR-003](ADR-003-supervised-local-auditor-scope.md) | Supervised Local Calibre Auditor Scope | 2026-07-15 | Accepted |
| [ADR-004](ADR-004-read-only-content-server-inventory.md) | Capability-Limited Content Server Adapter for Live Inventory | 2026-07-16 | Accepted |
